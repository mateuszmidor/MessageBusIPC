...
private:
    ...
    static void broadcastClientConnected(ThreadsafeChannelList &channel_list, MessageChannel &connected);
    static void broadcastClientDisconnected(ThreadsafeChannelList &channel_list, MessageChannel &disconnected);
